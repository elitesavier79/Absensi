                ...
                <div class="col-md-6">
                    <div class="card text-center">
                        <div class="card-body" style="margin: auto;">
                            <input type ="text" id="id" Value="<?php echo $_SESSION['id']?>">
                            <input type ="text" id="tanggal_masuk" Value="<?php echo $tanggal_masuk ?>">
                            <input type ="text" id="jam_masuk" Value="<?php echo $jam_masuk ?>">
